...
export class DepositComponent {
  ...
  submit(){
    ...
    if(isAmountValid){
      StaticData.accountDeposit = new AccountDepositByNumber(StaticData.account.accountNumber, amount);
      this.performDeposit();
    }
    else{
  ...
  performDeposit(){
    this.accountService.depositByNumber(StaticData.accountDeposit).subscribe(depositRes=>{
